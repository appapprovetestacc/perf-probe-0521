...
export const meta: MetaFunction = () => [
  { title: "Perf Probe" },
  {
    name: "description",
    content:
      "Perf Probe is a Shopify App that runs inside your store's admin. Install via Shopify admin → Apps to enable it on your storefront.",
  },
];
    ...
    >
      ...
      >
        ...
        <p style={{ margin: "0 0 1.75rem", color: "#666", fontSize: "0.95rem", lineHeight: 1.5 }}>
          Install on your Shopify store to start using Perf Probe.
        </p>
